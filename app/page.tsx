    ...
    <main>
      <div className="bg-gray-100 py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          AIとは:<br></br>”Artificial Intelligence”の略で
          人工知能のことを指します<br></br>
          ...
          <Link href="https://forms.gle/cbvGDiSEYFRbJr6b7" className="block bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow mt-6">
